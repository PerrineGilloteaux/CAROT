...
[hypoxi_level_mean, hypoxi_level_std, num_t,cell_num,o2_lev]=computehypoovertime2(fracD,numD,delT,O2_th,numsamples);
%day_ar = 0:num_t-1;
%plot(day_ar,hypoxi_level,'-'); hold on;
errorbar(hypoxi_level_mean,hypoxi_level_std/sqrt(numsamples));hold on;
legend_str = {legend_str{:} sprintf('%d Gy, %d fractions, %d delT Perf+Hypo',fracD,numD,delT)};
