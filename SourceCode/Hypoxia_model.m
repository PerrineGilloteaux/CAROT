...
function [cell_stack,o2_stack,cell_num,o2_lev] = Hypoxia_model(field_size,fracD,numD,delT,RTres,O2_th,leak_death,extra_days,O2_option,EC_death_option,cell_layer,parralel,alpha,beta,alv,bev,blood_density)
